...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      <div className="dot-background flex flex-col space-y-10">
      <section id="hero">
      ...
      <section id="about">
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <h2 className="section-heading section-heading-about">About</h2>
        </BlurFade>
      ...
      <section id="work">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 5}>
            <h2 className="section-heading section-heading-work">Work Experience</h2>
          </BlurFade>
      ...
      <section id="education">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 7}>
            <h2 className="section-heading section-heading-education">Education</h2>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                <Link
                  href="mailto:anaypatil0@gmail.com"
